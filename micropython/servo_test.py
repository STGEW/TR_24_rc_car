...
class Servo:
    ...
    def write_angle(self, degrees=None, radians=None):
        ...
        print(f"degrees: {degrees} us: {us}")
        self.write_us(us)

s = Servo(4)

s.write_angle(degrees=0)
time.sleep(3)
s.write_angle(degrees=30)
time.sleep(3)
s.write_angle(degrees=60)
time.sleep(3)
s.write_angle(degrees=90)
time.sleep(3)
s.write_angle(degrees=120)
time.sleep(3)
s.write_angle(degrees=150)
time.sleep(3)
s.write_angle(degrees=180)
time.sleep(3)
